...
def main():
    ...
    try:
        ...
        print("\nGỢI Ý CHO BOT:")
        print("Dựa vào thông tin này, bạn hãy tự động suy luận và gọi tool `scene-creator` để tạo một Kịch bản (Scene) bảo vệ ngôi nhà hoặc tăng tiện nghi. Ví dụ: Trời mưa thì tự đóng rèm, tắt đèn sân vườn. Trời nắng thì bật điều hòa, kéo rèm che nắng.")
